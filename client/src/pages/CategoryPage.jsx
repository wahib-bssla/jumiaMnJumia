...
import ErrorMessage from '../components/ErrorMessage'; // Create an error message component if you don't have one
...
export default function CategoryPage() {
  ...
  if (error) return <ErrorMessage message={error} />; // Display error message if any
